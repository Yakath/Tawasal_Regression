...
WebUI.click(findTestObject('Object Repository/Page_TAWASAL - Residence Renewal Request/input_End Date of Residence_ATCGlobalTheme__08d7cb'))

WebUI.click(findTestObject('Object Repository/Page_TAWASAL - Residence Renewal Request/td_28'))

WebUI.click(findTestObject('Object Repository/Page_TAWASAL - Residence Renewal Request/input_End Date of Residence_ATCGlobalTheme__783b2e'))
